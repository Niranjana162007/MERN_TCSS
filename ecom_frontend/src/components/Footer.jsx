      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              Your trusted partner for premium home furniture and decor. We bring style, comfort, and quality to every home.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/cart" className="text-gray-400 hover:text-orange-400 transition-colors">Cart</Link></li>
              <li><Link to="/orders" className="text-gray-400 hover:text-orange-400 transition-colors">Orders</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 EcomStore. All rights reserved. Built with React & Tailwind CSS.
          </p>
        </div>
      </div>
    </footer>
